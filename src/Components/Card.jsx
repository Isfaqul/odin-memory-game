export default function Card({ name, url, onClick }) {
  return (
    <div
      onClick={onClick}
      className="bg-cyan-500/30 h-80 lg:h-64 border border-cyan-500 p-3 bg-no-repeat bg-cover flex flex-col cursor-pointer transition ease-in-out duration-300 hover:shadow-lg shadow-cyan-400/50"
    >
